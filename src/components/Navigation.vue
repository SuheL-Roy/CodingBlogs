  ...
  <header>
            ...
            <div class="options">
              <div class="option">
                <router-link class="option" :to="{ name: 'Profile' }" >
                  <svg
                    ...
                    data-prefix="fal"
                    data-icon="user-alt"
                    class="svg-inline--fa fa-user-alt fa-w-16 icon"
                    role="img"
              ...
              <div class="option">
                <router-link class="option" :to="{ name: 'Admin' }">
                  <svg
                    ...
                    focusable="false"
                    data-prefix="fal"
                    data-icon="user-crown"
                    class="svg-inline--fa fa-user-crown fa-w-14 icon"
                    role="img"
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 448 512"
                  >
              ...
              <div @click="SignOut" class="option">
                <svg
                  ...
                  class="svg-inline--fa fa-sign-out-alt fa-w-16 icon"
                  role="img"
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 512 512"
                >
    ...
    <div @click="toggleMobileNav" v-show="mobile">
      <svg
        ...
        data-prefix="far"
        data-icon="bars"
        class="svg-inline--fa fa-bars fa-w-14 menu-icon"
        role="img"
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 448 512"
      >
